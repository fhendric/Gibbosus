...
Protein sequences were aligned using COBALT (https://www.ncbi.nlm.nih.gov/tools/cobalt/re_cobalt.cgi) and stored under `./all/cobalt/ache.isoseq.all.transcripts.fasta.transdecoder.cobalt.fasta`. Fasta headers were simplified using the command:
