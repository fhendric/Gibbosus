...
```sed 's/scaffold_//'g Ogib_2.0_vs_Ogib_1.0.synteny.paf | grep 'CM0332' | awk '$12==60 && $6<14 && $11>50000' > Ogib_2.0_vs_Ogib_1.0.synteny.filt.paf```

For ```Ogib_2.0_vs_Hgram.synteny.paf``` :

```sed 's/scaffold_//g' Ogib_2.0_vs_Hgram.synteny.paf | awk '$12==60 && $11>50000 && $1<14 && $6<14' > Ogib_2.0_vs_Hgram.synteny.filt.paf```
